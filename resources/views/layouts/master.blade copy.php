...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" data-widget="pushmenu" href="#" role="button" id="menubtn"><i class="fas fa-bars"></i></a>
                </li>
 ...
 Logo" class="brand-image " style="opacity: .8;width: 70%;">
                <span class="brand-text font-weight-bold text-dark mx-3" style="
                opacity: 0;
            ">Admin</span>
            </a>
    ...
    <script>
        $(document).ready(function() {
            $('.dropdown-toggle').on('click', function(e) {
                ...
                $('[data-dropdown="' + targetDropdown + '"]').slideToggle();
            });
        });
    </script>
