        ...
        <header class="tech-header header">
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand d-flex pt-3 pb-0" href="/">
                        {{-- <img src="{{ asset('frontend/images/version/tech-logo.png') }}" alt=""> --}}
                        <h3 class="text-white">LiveTime</h3><h4 class="text-warning">Reviews</h4>
                    </a>
