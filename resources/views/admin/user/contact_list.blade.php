                        ...
                        @foreach ($lists as $list)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-info" href="{{ route('admin.contact_all_reply', ['id' => $list['id']]) }}">All Replies</a>      
                                    
                                    <a class="btn btn-success" href="{{ route('admin.contact_detail', ['id' => $list['id']]) }}">Detail</a>

                                    
                                    <a class="btn btn-danger" href="{{ route('admin.delete_contact', ['id' => $list['id']]) }}"
